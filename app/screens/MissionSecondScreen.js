                        ...
                        <View style = {stylesGlobal.mission_shadow_view}>
                            <View style = {[stylesGlobal.mission_color_view, {backgroundColor: '#FE4A49'}]}>
                                ...
                                <View style = {{flex: 2, width: '100%', alignItems: 'center', justifyContent: 'center'}}>
                                    <TouchableOpacity style = {[stylesGlobal.mission_camera_container_view, {backgroundColor: '#db2c33'}]}>
                                ...
                                <View style = {{flex: 1.5, width: '100%', alignItems: 'center', justifyContent: 'center'}}>
                                    <TouchableOpacity style = {stylesGlobal.mission_button} onPress = {() => this.props.navigation.navigate("MissionThirdScreen")}>
