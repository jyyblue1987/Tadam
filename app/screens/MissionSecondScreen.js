...
export default class MissionSecondScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    next_mission = async() => {
        ...
        if(this.state.answerType == "IMAGE") {
            this.props.navigation.navigate("PictureCheckScreen", {answerType: "IMAGE", image_uri: this.state.image_uri, mission: 'second'});
        } else if(this.state.answerType == "VIDEO") {
            this.props.navigation.navigate("PictureCheckScreen", {answerType: "VIDEO", video_uri: this.state.video_uri, mission: 'second'});
        } else if(this.state.answerType == "TEXT") {
            this.props.navigation.navigate("PictureCheckScreen", {answerType: "TEXT", answer_text: this.state.answer_text, mission: 'second'});
        }
    }
            ...
            }
            {
                ...
                <View style = {styles.main_container}>
                    <View style = {{flex: 1, width: '100%', alignItems: 'center', marginTop: isIphoneX ? 55 : 20}}>
                        <Image style = {{width: 50, height: 50, resizeMode: 'contain'}} source = {require("../assets/images/mission_number2.png")}/>
                        <Text style = {[stylesGlobal.general_font_style, {fontSize: 24, marginTop: 20}]}>YOUR SECOND MISSION HEADING</Text>
                        <View style = {stylesGlobal.mission_shadow_view}>
                            <View style = {[stylesGlobal.mission_color_view, {backgroundColor: '#FE4A49'}]}>
                                ...
                                <View style = {{flex: 2, width: '100%', alignItems: 'center', justifyContent: 'center'}}>
                                    <TouchableOpacity style = {[stylesGlobal.mission_camera_container_view, {backgroundColor: '#db2c33'}]} onPress = {() => this.answerAction()}>
                                    {
